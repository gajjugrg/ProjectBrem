void pseudoscalar(){
	...
	TFile* i = new TFile("slicesDMG4_PS_Bias0.root");
	...
	TFile* k = new TFile("slicesDMG4_PS_Bias0_eps0.root");
	DMG4_e4_slice[0] = (TH1F*)k -> Get("slice0"); DMG4_e4_slice[0] -> SetLineColor(6);
	DMG4_e4_slice[1] = (TH1F*)k -> Get("slice1"); DMG4_e4_slice[1] -> SetLineColor(6);
	DMG4_e4_slice[2] = (TH1F*)k -> Get("slice2"); DMG4_e4_slice[2] -> SetLineColor(6);
	
	TH1F* DMG4_e5_slice[3];
	TFile* j = new TFile("slicesDMG4_PS_Bias1e5.root");
...
//	DMG4_e7_slice[0]->Draw("hist same");
	...
	leg->AddEntry(DMG4_e0_slice[0],"10 GeV/ DMG4 bais e0","le");
	leg->AddEntry(DMG4_e3_slice[0],"10 GeV/ DMG4 bais e3","le");
	leg->AddEntry(DMG4_e4_slice[0],"10 GeV/ DMG4 eps 0","le");
...
//	DMG4_e7_slice[1]->Draw("hist same");
	...
	leg1->AddEntry(DMG4_e0_slice[1],"30 GeV/ DMG4 bais e0","le");
	leg1->AddEntry(DMG4_e3_slice[1],"30 GeV/ DMG4 bais e3","le");
	leg1->AddEntry(DMG4_e4_slice[1],"30 GeV/ DMG4 eps 0","le");
...
//	DMG4_e7_slice[2]->Draw("hist same");
	...
	leg2->AddEntry(DMG4_e0_slice[2],"45 GeV/ DMG4 bais e0","le");
	leg2->AddEntry(DMG4_e3_slice[2],"45 GeV/ DMG4 bais e3","le");
	leg2->AddEntry(DMG4_e4_slice[2],"45 GeV/ DMG4 eps 0","le");
