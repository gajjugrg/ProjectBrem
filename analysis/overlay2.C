...
DMG4_slice[0] = (TH1F*)h -> Get("slice0"); DMG4_slice[0] -> SetLineColor(24); DMG4_slice[0] -> Sumw2();
DMG4_slice[1] = (TH1F*)h -> Get("slice1"); DMG4_slice[1] -> SetLineColor(27); DMG4_slice[1] -> Sumw2();
DMG4_slice[2] = (TH1F*)h -> Get("slice2"); DMG4_slice[2] -> SetLineColor(34); DMG4_slice[2] -> Sumw2();
...
DMG4_slice[0]->Scale(.1/DMG4_slice[0]->Integral(), "width");

	Ana_slice[0]->Draw("hist");
	MC_slice[0]->Draw("same");
	DMG4_slice[0]->Draw("same");
